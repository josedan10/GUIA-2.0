...
@section('home')
    ...
    <section class="home container center" id="home">
...
@section('about-us')
    ...
    <section class="about-us container center vertical" id="aboutUS">
